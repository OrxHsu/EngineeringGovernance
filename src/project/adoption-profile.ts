...
export interface AdoptionAdapter {
  tool: string
  source: string
  targets: string[]
}
...
export interface AdoptionProfile {
  projectId: string
  adapters: AdoptionAdapter[]
}

function repositoryProjectId(projectRoot: string): string {
  try {
...
function isProjTravWorkspace(projectRoot: string): boolean {
  return [
    'Docs/AGENTS.md',
...
function isEngineeringGovernance(projectRoot: string): boolean {
  return [
    'CORE_INVARIANTS.md',
    'DEVELOPMENT_SOP.md',
...
function isNoMeWorkspace(projectRoot: string): boolean {
  return [
    'AGENTS.md',
    'Docs/ODD.md',
    'project.yml',
...
export function adoptionProfile(projectRoot: string): AdoptionProfile {
